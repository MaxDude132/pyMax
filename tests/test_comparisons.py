...
def test_equals():
    ...
    assert run_source("print(1 == 'test')") == formatted_error(
        "Error at ''test'': Expected Int but got String for parameter other in call to equals.",
        1,
    )
    ...
    assert run_source("print('true' == true)") == formatted_error(
        "Error at 'true': Expected String but got Bool for parameter other in call to equals.",
        1,
    )
    ...
    assert run_source("print(List(1) == 2)") == formatted_error(
        "Error at '2': Expected List but got Int for parameter other in call to equals.",
        1,
    )
    ...
    assert run_source("print(Map(1 -> 'test') == 2 -> 'test2')") == formatted_error(
        "Error at '->': Expected Map but got Pair for parameter other in call to equals.",
        1,
    )
...
def test_greater():
    ...
    assert run_source("print(1 > 1)") == "false"
    assert run_source("print(1 > 1.0)") == "false"
    assert run_source("print(1.0 > 1)") == "false"
...
def test_greater_equals():
    ...
    assert run_source("print(1 >= 1.0)") == "true"
    assert run_source("print(1.0 >= 1)") == "true"
    assert run_source("print(1.3 >= 1.2)") == "true"
    assert run_source("print(1.2 >= 1.2)") == "true"
    assert run_source("print(1.1 >= 1.2)") == "false"
    assert run_source("print('test' >= 'test ')") == formatted_error(
