...
print(value)
        ...
        "Error at 'print': Expect 'else' clause after then branch of if expression.", 9
    )
...
print(value)
        ...
        "Error at 'if': Got different return types in if expression: <class String> and <class Int>.",
        4,
    )
