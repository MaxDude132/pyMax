...
def test_addition():
    ...
    assert run_source("print('true' + true)") == formatted_error(
        "Error at 'true': Expected String but got Bool for parameter value in call to add.", 1
    )
...
def test_multiplication():
    ...
    assert run_source("print('test' * 't')") == formatted_error(
        "Error at ''t'': Expected Int but got String for parameter value in call to multiply.", 1
    )
